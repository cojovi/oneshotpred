  ...
  return (
    <div className="max-w-7xl mx-auto mt-20 grid grid-cols-3 gap-16 justify-items-center xxs:grid-cols-1 sm:grid-cols-3">
      <AboutTeamCard
        ...
        position="Jenna, Project Controls"
      ></AboutTeamCard>
      <AboutTeamCard
        ...
        position="Marcus, Superintendent"
      ></AboutTeamCard>
      <AboutTeamCard
      ...
      <AboutTeamCard
        ...
        position="Kristina, Quality Lead"
      ></AboutTeamCard>
      <AboutTeamCard
      ...
      <AboutTeamCard
        ...
        position="David, Site Coordinator"
      ></AboutTeamCard>
    </div>
  )
}
